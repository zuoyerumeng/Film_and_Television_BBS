...
function codeinit(id,obj){
	if(is_ie){
		...
		$(id).innerHTML = '<embed src="include/clipboard.swf" flashvars="clipboard='+encodeURIComponent(code)+'" quality="high" allowscriptaccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" width="14" height="15" title='+lang['copy_code']+'>';
	}
}
